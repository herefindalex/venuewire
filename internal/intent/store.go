...
type Plan struct {
	...
	ValidTick            string    `json:"validTick"`
	EstimatedNotionalUSD string    `json:"estimatedNotionalUsd"`
	MetadataAt           time.Time `json:"metadataAt"`
	PriceAt              time.Time `json:"priceAt"`
	CODProtected         bool      `json:"codProtected"`
