...
func setValidWebEnvironment(t *testing.T) {
	...
	for _, key := range []string{
		...
		"QUICK_TRADE_MAX_ETH", "QUICK_TRADE_MAX_USDT", "QUICK_TRADE_MAX_USDC", "DEMO_MAX_TRADES_PER_SESSION",
		"DEMO_MAX_TRADES_PER_HOUR", "DEMO_MAX_CONCURRENT_TRADES", "DEMO_MAX_BYBIT_BTC_QTY", "DEMO_MAX_BYBIT_ETH_QTY",
		"DEMO_MAX_BYBIT_USDT_AMOUNT", "DEMO_MAX_DERIBIT_BTC_AMOUNT", "DEMO_MAX_DERIBIT_USDC_AMOUNT",
	} {
